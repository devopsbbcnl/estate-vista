        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3 reveal-up reveal-up-delay-3">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-mist/30 text-mist hover:bg-mist/10 active:scale-[0.97] transition-all"
            >
              Book a Demo
            </Button>
          </div>
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-xl reveal-up reveal-up-delay-4">
          {stats.map((s) => (
            <div key={s.label} className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-mist/10 flex items-center justify-center">
